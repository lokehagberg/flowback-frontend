...
<div class="flex justify-center mt-16 gap-16">
	...
	<div>
		<div class="bg-white shadow rounded flex flex-col">
			...
			<GroupSidebarButton action={() => (selectedPage = selectablePages.flow)} text="Delegation" />
			<GroupSidebarButton action={() => (selectedPage = selectablePages.documents)} text="Documents"/>
		...
		<div class="bg-white shadow rounded flex flex-col mt-6">
			...
			<GroupSidebarButton action={() => (window.location.href = '/createpoll')} text="Video Conference"/>
